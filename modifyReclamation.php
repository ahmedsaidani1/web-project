...
<head>
    <meta charset="utf-8">
    <title>DASHMIN - Modify Reclamation</title>
                ...
                <form method="POST">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0"># Modifier une réclamation</h6>
                        </div>
                        <div class="col-12">
                            <label for="floatingText">Message :</label>
                            <textarea type="text" name="message" class="form-control"><?php echo $rec['message']?></textarea>
                            <br>
                        </div>
                        <div class="col-12">
