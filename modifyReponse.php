...
if (
    ...
    if (
        ...
        $reponseC->modifierReponse($reponse, $_GET['id']);
...
<head>
    <meta charset="utf-8">
    <title>DASHMIN - Modify Reponse</title>
                ...
                <form method="POST">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0"># Modifier une réponse</h6>
                        </div>
                        <?php 
                            if (isset($_GET['id'])){
                        ...
                        <form method="POST">
                            <div class="col-12">
                                ...
                                <textarea type="text" name="message" class="form-control"><?php echo $rep['message']?></textarea>
                                <br>
                            </div>
                            <div class="col-12">
                                <select name="id_reclamation">
                                    <option value="<?php echo $rep['id_reclamation']?>"><?php echo $rep['id_reclamation']?></option>
                                </select>
                            </div>
