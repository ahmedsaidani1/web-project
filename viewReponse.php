...
<head>
    <meta charset="utf-8">
    <title>DASHMIN - View Reponse</title>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0"># Liste des réponses</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $rep['message']?></td>
                                    <td><?php echo $rep['id_reclamation']?></td>
                                    <td><a class="btn btn-sm btn-primary" href="modifyReponse.php?id=<?php echo $rep['id']; ?>">Modifier</a></td>
                                    <td><a class="btn btn-sm btn-primary" href="deleteReponse.php?id=<?php echo $rep['id']; ?>">Supprimer</a></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
